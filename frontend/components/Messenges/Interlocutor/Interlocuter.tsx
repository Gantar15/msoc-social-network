...
const Interlocuter: FC<IProps> = ({interlocutor, lastMessenge, setInterlocutorRoom}) => {
    const {data: authUser} = useQuery<{getAuthUser: IAuthUser}>(getAuthUser);

    return (
        <div className={styles.interlocutor} onClick={() => setInterlocutorRoom(interlocutor.id)}>
